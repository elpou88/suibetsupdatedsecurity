/// OZ-inspired safe arithmetic module for SuiBets — p2p_betting package.
///
...
module p2p_betting::safe_math {
    ...
    /// Used for three-way pool snapshot calculations.
    ...
    /// Equivalent to OZ Math.saturatingSub. Used for net_fee_bps floor-zero logic.
