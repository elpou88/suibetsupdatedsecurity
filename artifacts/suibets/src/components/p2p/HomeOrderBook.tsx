...
function OfferCard({
  ...
  return (
    <div
      className={`bg-[#0d1117]/95 backdrop-blur-sm border border-[#1e2a3a] rounded-xl overflow-hidden transition-all duration-200 ${accent.border} ${accent.glow} ${
        justFilled
...
function ParlayCard({
  ...
  return (
    <div
      className={`bg-[#0d1117] border border-[#1e2a3a] rounded-xl overflow-hidden transition-all border-l-4 border-l-purple-500 ${accent.glow} ${
        justFilled
