...
const NavigationBar = () => {
  ...
  // Keep badge count in sync with settlement notifications from WebSocket
  useEffect(() => {
        ...
        {user?.walletAddress ? (
          <div className="flex items-center">
            ...
            <Button 
              variant="ghost" 
              size="icon"
              className="relative text-white hover:text-[#00FFFF] hover:bg-[#112225] mx-1"
          ...
          <div className="flex flex-col items-end gap-0.5">
            ...
            <Button 
              className="bg-[#00FFFF] hover:bg-[#00FFFF]/90 text-black font-medium flex items-center gap-2" 
