...
export default function Footer() {
  return (
    <footer className="bg-[#032F36] p-6 border-t border-[#04363E]">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li><span className="hover:text-primary cursor-pointer" onClick={() => window.location.href="/settlement"}>Settlement Transparency</span></li>
      ...
      <BettingLimitsNotice borderColor="border-[#04363E]" textColor="text-gray-400" mutedColor="text-gray-500" />

      <div className="mt-4 pt-4 border-t border-[#04363E] text-center text-sm text-gray-400">
        <div className="flex items-center justify-center gap-2 mb-3">
          <a
            href="https://suiscan.xyz/mainnet/account/0xd51fe151bec66a15b086a67c1cfce9b05759ddac1d73fcd3e14324ad202b2e59"
            target="_blank"
