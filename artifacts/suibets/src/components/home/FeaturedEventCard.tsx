          ...
          {event.markets && event.markets[0] && event.markets[0].outcomes ? (
            <>
              ...
              >
                <div className="flex flex-col items-center w-full">
                  ...
                  <span className="text-lg font-bold">
                    {event.markets[0].outcomes[0]?.odds ? `${Math.round(100 / event.markets[0].outcomes[0].odds)}%` : '50%'}
                  </span>
                </div>
              </Button>
              ...
              >
                <div className="flex flex-col items-center w-full">
                  ...
                  <span className="text-lg font-bold">
                    {event.markets[0].outcomes[1]?.odds ? `${Math.round(100 / event.markets[0].outcomes[1].odds)}%` : '29%'}
                  </span>
                </div>
              </Button>
            </>
            ...
            <>
              ...
              >
                <div className="flex flex-col items-center w-full">
                  <span className="text-sm font-medium">{event.awayTeam}</span>
                  <span className="text-lg font-bold">53%</span>
                </div>
              </Button>
            </>
          )}
