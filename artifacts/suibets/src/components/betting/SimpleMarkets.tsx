      ...
      <Card className="mb-6 border-[#1e3a3f] bg-gradient-to-b from-[#14292e] to-[#112225] shadow-lg shadow-cyan-900/10">
        ...
        <CardContent className="flex flex-wrap gap-3 p-4">
          ...
          >
            ...
            <span className="text-sm font-bold mt-1 bg-[#0f3942] text-cyan-300 px-3 py-1 rounded-md shadow-inner shadow-cyan-900/30">{Math.round(100 / resolvedHomeOdds)}%</span>
          </Button>
          ...
          {hasDraw && resolvedDrawOdds && (
            ...
            >
              ...
              <span className="text-sm font-bold mt-1 bg-[#0f3942] text-cyan-300 px-3 py-1 rounded-md shadow-inner shadow-cyan-900/30">{Math.round(100 / resolvedDrawOdds)}%</span>
            </Button>
          )}
          ...
          >
            ...
            <span className="text-sm font-bold mt-1 bg-[#0f3942] text-cyan-300 px-3 py-1 rounded-md shadow-inner shadow-cyan-900/30">{Math.round(100 / resolvedAwayOdds)}%</span>
          </Button>
        </CardContent>
      </Card>
        ...
        <Card className="mb-6 border-[#1e3a3f] bg-gradient-to-b from-[#14292e] to-[#112225] shadow-lg shadow-cyan-900/10">
          ...
          <CardContent className="flex gap-3 p-4">
            ...
            >
              ...
              <span className="text-sm font-bold mt-1 bg-[#0f3942] text-cyan-300 px-3 py-1 rounded-md shadow-inner shadow-cyan-900/30">53%</span>
            </Button>
            <Button
              variant="outline"
