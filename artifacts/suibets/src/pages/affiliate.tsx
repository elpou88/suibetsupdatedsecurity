...
import { ArrowLeft, Users, DollarSign, TrendingUp, Gift, Zap, BarChart, Shield, CheckCircle, ExternalLink, Lock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black" data-testid="affiliate-page">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/30 rounded-2xl p-6 mb-6" data-testid="onchain-verification-banner">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-white font-bold text-lg flex items-center gap-2">
                On-Chain Verified Referrals
                <span className="inline-flex items-center gap-1 bg-green-500/20 border border-green-500/40 text-green-400 text-[10px] font-bold px-1.5 py-0.5 rounded-full">
                  <CheckCircle size={10} />
                  VERIFIED
                </span>
              </h3>
              <p className="text-gray-400 text-sm mt-1 mb-3">
                All referral relationships are tracked on the Sui blockchain and stored on Walrus for tamper-proof transparency.
              </p>
              <div className="flex flex-wrap gap-3">
                <div className="flex items-center gap-1.5 text-xs text-gray-300 bg-[#111]/80 border border-cyan-900/30 rounded-lg px-3 py-1.5">
                  <Lock size={12} className="text-cyan-400" />
                  Anti-sybil verification (0.01 SUI minimum)
                </div>
                <div className="flex items-center gap-1.5 text-xs text-gray-300 bg-[#111]/80 border border-cyan-900/30 rounded-lg px-3 py-1.5">
        ...
        <div className="space-y-6">
          ...
          <section className="bg-[#111111] border border-purple-900/30 rounded-2xl p-6" data-testid="referral-chain-transparency">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <Shield className="h-5 w-5 text-purple-400" />
              Referral Chain Transparency
            </h2>
            <div className="space-y-3">
              <div className="flex items-center gap-3 bg-[#0b1618]/60 border border-cyan-900/20 rounded-lg p-4">
                <CheckCircle size={18} className="text-green-400 flex-shrink-0" />
                <div>
                  <h4 className="text-white font-medium text-sm">Wallet Verification</h4>
                  <p className="text-gray-500 text-xs">Each referred wallet is verified on-chain with minimum 0.01 SUI balance</p>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-[#0b1618]/60 border border-cyan-900/20 rounded-lg p-4">
                <CheckCircle size={18} className="text-green-400 flex-shrink-0" />
                <div>
                  <h4 className="text-white font-medium text-sm">Immutable Tracking</h4>
                  <p className="text-gray-500 text-xs">Referral data stored on Walrus decentralized storage — can never be altered</p>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-[#0b1618]/60 border border-cyan-900/20 rounded-lg p-4">
                <CheckCircle size={18} className="text-green-400 flex-shrink-0" />
                <div>
                  <h4 className="text-white font-medium text-sm">Smart Contract Rewards</h4>
                  <p className="text-gray-500 text-xs">Commission payouts executed through on-chain smart contracts with full audit trail</p>
                </div>
              </div>
            </div>
          </section>
