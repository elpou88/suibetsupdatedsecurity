          ...
          return (
            <div className="space-y-5">
                                  ...
                                  if (NFT_PACKAGE_ID && NFT_MINT_AUTHORITY_ID) {
                                    ...
                                    fetch('/api/nft/confirm-mint', {
                                      ...
                                      if (!r.ok) {
                                        ...
                                        console.error('[NFT] confirm-mint failed:', r.status, body);
                                      }
                                    }).catch((e) => console.error('[NFT] confirm-mint network error:', e));
                                  } else {
              ...
              <div className="text-center pt-2 pb-4">
                ...
                <a href={window.location.origin} className="text-cyan-700 hover:text-cyan-500 text-xs">{window.location.hostname}</a>
              </div>
            </div>
          );
        })()}
