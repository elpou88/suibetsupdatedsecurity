  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        'Football (Soccer) - Live betting (up to 85th minute) + upcoming matches via paid API-Sports integration with real bookmaker odds.',
    ...
    },
    {
      ...
      content: [
        ...
        'Server-Authoritative Betting Cutoff: For football, live betting is allowed up to the 85th minute. For free sports, betting closes once the match starts (no live betting). The server determines match status - client flags are ignored.',
