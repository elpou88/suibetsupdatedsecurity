...
CREATE TABLE IF NOT EXISTS p2p_bet_matches (
  id SERIAL PRIMARY KEY,
  offer_id INTEGER REFERENCES p2p_bet_offers(id) NOT NULL,
...
CREATE TABLE IF NOT EXISTS p2p_parlay_legs (
  id SERIAL PRIMARY KEY,
  parlay_offer_id INTEGER REFERENCES p2p_parlay_offers(id) NOT NULL,
...
-- Indexes
CREATE UNIQUE INDEX IF NOT EXISTS idx_referrals_referred_wallet ON referrals (referred_wallet);
